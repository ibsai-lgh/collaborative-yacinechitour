\begin{exercise}[When is the union of subspaces a subspace?]
    ...
    \begin{solution}[Toma]
       ...
       To prove the inverse implication, assume $U \subseteq W$. Hence, $U \cup W = W$ which is a subspace.
        ...
        Now let's return to the main proof. Assume $U \cup W$ is a subspace. We want to prove that $U \subseteq W$ or $W \subseteq U$.
        
        Take $u \in U$, an arbitrary vector. If $W \setminus U = \emptyset$, then $W \subseteq U$, thus the result still holds, otherwise consider $w \in W \setminus U$. Notice that both elements belong to $U \cup W$, therefore $u + w \in U \cup W$, since it is a subspace. But using our lemma, $u + w \notin U$, which implies $u + w \in W$. Since $w \in W \Rightarrow -w \in W$, by adding two elements from W, we obtain an element of W since it is a subspace, so: $(u+w) + (-w) \in W$. We just showed $u \in W$. Hence, $U \subseteq W$.
